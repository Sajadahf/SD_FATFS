...
#define LD_ON HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0, GPIO_PIN_RESET); //RED
#define LD_OFF HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0	, GPIO_PIN_SET); //RED
//--------------------------------------------------
...
typedef struct sd_info {
  volatile uint8_t type;//§ä§Ú§á §Ü§Ñ§â§ä§í
} sd_info_ptr;
//--------------------------------------------------
